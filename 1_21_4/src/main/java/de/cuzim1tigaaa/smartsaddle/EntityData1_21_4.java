...
public class EntityData1_21_4 implements EntityData {

	@Override
	public AttributeInstance getMovementSpeed(LivingEntity livingEntity) {
		return livingEntity.getAttribute(Attribute.MOVEMENT_SPEED);
	}

	@Override
	public AttributeInstance getMaxHealth(LivingEntity livingEntity) {
		return livingEntity.getAttribute(Attribute.MAX_HEALTH);
	}
}